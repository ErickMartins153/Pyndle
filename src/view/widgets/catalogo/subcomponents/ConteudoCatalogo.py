...
from src.view.widgets.catalogo.subcomponents.PainelFiltro import PainelFiltro
from src.view.widgets.catalogo.subcomponents.PainelLivros import PainelLivros
