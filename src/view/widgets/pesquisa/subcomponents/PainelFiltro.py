...
class PainelFiltro(QtWidgets.QFrame):
    ...
    **ATRIBUTOS:**
    ...
    def botaoFiltrarClicado(self):
        ...
        widgetSearch.getIrmaos(self)["painelLivrosResultado"].getLivrosFiltro(self.generoMarcado, self.ordemAlf)
        # Atualiza os livros dispostos
        widgetSearch.getIrmaos(self)["painelLivrosResultado"].resizeAndDisplayFiltro()
